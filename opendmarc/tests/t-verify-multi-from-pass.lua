...
-- setup
sock = "unix:" .. mt.getcwd() .. "/t-verify-multi-from-pass.sock"
binpath = mt.getcwd() .. "/.."
...
mt.startfilter(binpath .. "/opendmarc", "-l", "-c", "t-verify-multi-from-pass.conf",
               "-p", sock)
...
mt.macro(conn, SMFIC_MAIL, "i", "t-verify-multi-from-pass")
...
if mt.header(conn, "From", "user1@example.com, user2@example.com, user3@example.com") ~= nil then
